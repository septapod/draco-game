...
This document is intended to serve as the canonical reference for all Draco adaptations: tabletop game, video game, book series, video series, and beyond.
...
14. World Rules & Lore
15. Draco Legends
16. Progression & Win Condition
17. Game Balance & Restrictions
18. Story Moments & Narrative Beats
19. Open Questions & Future Development
...
**Dragonette Keepers** — The human players/characters at the beginning rank. Each Keeper collects, trains, bonds with, and races dragonettes. With a deep enough bond and the right artifact, a Keeper can even transform into one of their dragons. Keepers who complete their journey become Dragonette Masters.

**Dragonette Master** — The title earned by a Keeper who collects 10 racing badges and defeats Draco. Becoming a Master unlocks additional abilities (like special power-ups for your dragons). Once you achieve this rank, you are a Master — no longer just a Keeper.
...
Mountain. A brand-new element belonging to the legendary dragon Nalia. Mountain dragons are mountain-sized, mountain-shaped, and treated by the world the way real mountains are treated, only more so because the world knows they are dragons. The element exists for legendary dragons only (so far, just Nalia). See Section 15 (Draco Legends). Powers and matchups are TBD by Aza. Color cue: slate-ochre placeholder (TODO: Aza to pick).
...
Dragons can be identified by their element based on their color:

Fire — Red and orange tones
Water — Blue tones
Grass — Green tones
Electric — Yellow
Psychic — Mostly purple with pink stripes along the seam where the top of the body meets the sides
Spirit — Dark purple, with a gem on the forehead; spectral, translucent qualities
...
Mountain. Slate-ochre placeholder, TODO: Aza to pick. Legendary-only element (Nalia). Visual reference is the mountain form itself: forest on the back, snow cap that becomes wings on waking, calm closed eyes when sleeping.
...
Fire breath and fire-based attacks. Standard combat abilities. Extremely effective against shelled enemies — only 2 fire hits needed to defeat them (vs. 100 non-fire hits). Weak to Water.

### Water

Water-based powers (details to be expanded). Weak to Grass.

### Grass

Razor leaves — can create walls of sharp leaves as obstacles. Strong against Thunder Cloud element. Leaf-based attacks and defenses. Weak to Fire.
...
Telekinesis: picking up and throwing objects with the mind. Making things disappear (e.g., dissolving cardboard or physical objects). Unlocking doors without a key. Psychokinetic beam (energy attack). Note: Psychic dragons do NOT read minds — that is a common misconception in-world.
...
Access to ALL element abilities. Each individual element ability is weaker than a specialist's version. Exception: Speed ability is equal to a true Speed dragon (270 mph top speed). Weak to Thunder Cloud and Electricity.

### Speed

Extreme top speed: 270 mph (vs. normal dragon speed of 50 mph). "As fast as a peregrine falcon." Note: 270 mph is the maximum — Speed dragons can fly slower when they choose. This speed is their best move.
...
Mountain is Nalia's element. Specific powers and signature attacks are TBD by Aza. Known traits: the dragon is mountain-sized and mountain-shaped, with caves inside her, a forest on her back, and a snow cap that becomes wings on waking. During her one-year wake cycle she helps other dragons, flies, visits Marcus, and fights bad guys (including The Voice Below and Wonky Donkers). She is singular and eternal; she does not lay eggs. See Section 15 (Draco Legends) for the full canon. Matchups: TODO: Aza to decide.

### Silver Moonlight (Special Ability)

The only *known* time-restricted power. Only works at nighttime. Associated with Spirit-type dragons. Note: There are additional unknown time-restricted powers — including some that only work during daytime — that are unlocked when a player obtains the Thunder Cloud element.

### Core Elemental Cycle

The main elemental matchup cycle is: Grass is weak to Fire. Fire is weak to Water. Water is weak to Grass.

---

## 5. Getting Your First Dragon

### The First Choice Stable

The adventure begins at the First Choice Stable — a location filled with dragon eggs, each topped with a berry. (Note: berries are only found resting on eggs at the First Choice Stable — they are not found on eggs elsewhere in the world.)

Process:
1. Visit the First Choice Stable
2. Browse the available eggs (each has a berry resting on top)
3. Choose ONE egg
4. The egg hatches — a full-sized dragonette emerges
5. Before the dragon eats the berry, take it and hand-feed it to the newborn dragonette
6. This act of feeding bonds the dragon to you — it becomes your first dragonette

Important: You can only choose one dragon at the First Choice Stable. There are multiple stables (implied by the name "First" Choice Stable), suggesting players may visit others later.

---

## 6. Taming & Bonding

Dragons can be acquired beyond the First Choice Stable through discovery and care.

### Wild Dragon Taming

Dragons can be found in the wild during adventures. To tame a wild dragon, you must care for it. The taming process involves two key steps:

1. **Place element crystals on the dragon's wings.** Every dragon has crystal slots along the edges of its wings. You must find crystals matching the dragon's element and fill these slots. (For example, grass crystals for a Grass dragon, fire crystals for a Fire dragon, etc.)
2. **Feed it a berry and/or element candy.** Berries and element-specific candy strengthen the bond.

You CAN feed a berry before placing all the crystals, but the resulting bond will be weaker. For a full bond, complete the crystal slots on the wings AND feed the dragon. If you take care of a dragon, it will want to stay with you.
...
Berries are NOT found on eggs outside of the First Choice Stable. In the wild, berries are found in dragon nests or growing on berry plants — vines with ancient markings. Different berry types exist for different elements.
...
A Keeper must possess a Dragon Eye Amulet — a glowstone that contains the eye of a dragon within it. The amulet always glows, and the Keeper can call any of their bonded dragons to their side at any time. But with a sufficiently deep bond, the amulet enables something far more powerful: the Keeper can transform into one of their dragons entirely.

#### Who Is in Control?

The Keeper remains fully in control during transformation. They gain all of that dragon's physical abilities, elemental powers, and form while retaining their own mind and will.

#### Thunder Cloud Transformation:

If a Keeper transforms into a Thunder Cloud element dragon, they gain lightning feathers — lightly glowing feathers that can release charged particles. When these particles combine, they generate real thunder and lightning.

#### Significance:

Keeper Transformation represents the ultimate expression of the bond between a human and a dragonette. It is not something that happens easily or early in the game — it requires deep trust, care, and a powerful artifact. This mechanic has rich potential across all media: in the tabletop game it could be a late-game ability, in books it could be a climactic moment, and in the video game it could be an unlockable power.

---

## 7. Items & Resources

**Berries** — Central to taming and bonding. Found on eggs at the First Choice Stable, in dragon nests in the wild, or growing on berry plants (vines with ancient markings). Feeding berries to dragons strengthens the bond.

**Element Crystals** — Crystals matching a dragon's element type, placed into the crystal slots along the edges of a dragon's wings. Required for a full bond when taming wild dragons. (Examples: grass crystals for Grass dragons, fire crystals for Fire dragons, etc.)

**Element Candy** — Fed to dragons to help complete the bonding/taming process. Each element has its own candy type. (Examples: grass candy for Grass dragons, fire candy for Fire dragons, etc.)

**Special Berries** — Rare berries found only inside the Tow Road's dimension. When fed to a dragon, they make it slightly faster — helpful in races, but not fast enough to match the banned Power or Speed dragons.
...
The Crystal is a special artifact used to identify a dragon's powers.

How it works:

You must look directly through the Crystal with one eye. While looking through the Crystal, you must simultaneously be looking at a dragon. The Crystal will then reveal that dragon's powers to you.

This is the only reliable way to identify what powers a dragon possesses. It could serve as an important plot device and gameplay mechanic across all media.

---

## 9. Racing

Racing is the primary competitive activity in Draco and the main way to earn badges toward becoming a Dragonette Master.

### Structure

Races take place in racing stadiums. Stadiums can be built/created by Aloha (the humanoid robot). Aloha also announces and hosts the races.
...
A trophy appears during the race and begins flashing. To win, you must pass through the trophy while it is still visible. Timing is critical — the flashing means it appears and disappears.

### Cheating & Enforcement

Villain characters (like Wonky Donkers) sometimes try to disguise banned dragons to sneak them into races. Spirit dragons can detect disguised dragons (truth-sensing ability). Psychic dragons can remove disguises (e.g., making cardboard costumes disappear). Aloha enforces the rules by literally kicking out cheaters with a giant robotic boot.
...
Enemies with shells made of dragon scale energy are extremely durable. Non-fire attacks (psychic attacks, throwing trees, etc.) deal only about 1% damage per hit — meaning it would take roughly 100 hits to defeat one. Fire attacks, however, are devastatingly effective: only about 2 fire-breath hits are needed to break through the shell. Using a Fire dragon against shelled enemies is highly recommended.

### Elimination

Normal players: dragon simply cannot battle anymore and is removed. Evil characters: get literally kicked out by Aloha's giant robotic boot (a robot built by Aloha that constructs a massive boot specifically to kick out villains).
...
The core elemental cycle: **Grass → Fire → Water → Grass** (Grass is weak to Fire, Fire is weak to Water, Water is weak to Grass).
...
Mountain (Nalia's element) is legendary-only. Strong against: TODO: Aza to decide. Weak to: TODO: Aza to decide. When Aza picks Mountain's matchups, the reciprocal entries on the affected elements above will need updating too.

---

## 11. Dragon Scale & Force Fields

Dragon scales are a defensive resource obtained from defeating enemies whose shells are made of pure dragon scale energy.

### How Dragon Scales Work

1. Defeat an enemy with a dragon scale energy shell (e.g., the Tow Road, the Evil Groundhog, or Draco's evil shell)
2. The enemy dissipates into a dragon shell crystal that hardens into a dragon scale
3. Find the empty spot on your dragon where a scale is missing
4. Slide the new scale into place among the existing scales
5. A force field activates around your dragon

### Force Field Properties

Absorbs incoming attacks. Can reflect absorbed attacks back at the attacker. Has a sensitivity percentage that decreases with use (starts high, degrades as it absorbs hits). Dragon Scale material is weak to fire — fire attacks may bypass or damage the force field.
...
Abilities: Builds racing stadiums, constructs other robots, enforces race rules. Built a robot that constructs a giant boot to literally kick evil participants out of events.

Significance: Both the public face of organized dragon racing AND the infrastructure behind it. Aloha is the racing world.
...
Weakness: Grass element.

Reward: Upon defeat, Draco is freed from the evil shell, tamed, and joins your team — unlocking the Thunder Cloud element. You must feed it a berry and candy to complete the bond.

Requirements: Must have 10 racing badges to challenge it.
...
Role: Adventure enemy / world boss. Description: A giant evil turtle with wings. Its shell is made of pure dragon scale energy. Abilities: Can fly, has dragon-scale-energy shell armor. Weakness: Fire (2 fire hits to defeat; non-fire attacks deal only ~1% damage each). Drops: Dragon scale material and turtle meat when defeated.

The Tow Road's Dimension: The Tow Road has its own dimension that players can enter. Inside this dimension, the Tow Road is more powerful. When defeated there, it drops meat, a dragon scale, AND a special berry — a rare item that makes a dragon slightly faster (helpful in races, but not fast enough to match banned dragons).
...
Marcus also has a much earlier chapter in his life that few know about: as a kid, he found and raised the legendary dragon Nalia. He cared for her when she was a tiny blue cylinder with two wings, two tiny claws, two tiny paws, and a chest full of medals from the contests she kept winning. When Nalia was big enough, Marcus released her into the world. Their bond persists across her sleep cycles, and she visits him during her one-year wake every two million years. See Section 15 (Draco Legends).
...
Dragonettes hatch from eggs at full adult size. Despite being "babies," they are enormous. Each dragon has crystal slots along the edges of its wings (for bonding crystals) and a spot where a scale is missing (where dragon scale armor can be placed). Dragons breathe colored fire matching their element.
...
The bond between Keeper and dragonette exists on a spectrum. At its simplest, a Keeper feeds, trains, and races their dragons. At its deepest, the bond enables transformation — the Keeper physically becomes the dragon while retaining their own mind and will. This transformation is made possible by the Dragon Eye Amulet. The depth of this bond is a central theme of Draco and drives much of the emotional storytelling.

### The Day/Night Cycle

The world has a day/night cycle that affects gameplay. Most abilities work at all times. "Silver Moonlight" only works at night — the sole *known* time-restricted power. Additional unknown time-restricted powers (including daytime-only abilities) are unlocked with the Thunder Cloud element.
...
Holographic communication (Aloha's hologram iPhone). Advanced robotics (Aloha, the kicking-boot robot). The world blends fantasy (dragons, magic, elemental powers) with technology (robots, holograms, stadiums).

---

## 15. Draco Legends

Draco Legends are dragons whose story has grown beyond their own life into the shape of the world. They are not stronger than other dragons just because they are legendary. They are legendary because what they are and what they have done has become inseparable from the world itself. There are very few of them. The world remembers each one and treats them accordingly.

Draco himself is not a legend in this sense. He is the namesake of the game and the ultimate raid boss, but he is not in this chapter. Power Up is not a legend either. New legends will be added over time, made up by Aza.

This is the chapter where legends are documented. At launch it holds one.

### Nalia

Pronunciation: NAH-lee-yah. She/her.

Element: Mountain (legendary-only). See Section 2 and Section 4 for the element entry. Matchups are TBD by Aza.

Tamer: Marcus (The Finisher). Marcus found Nalia as a kid, raised her, and released her into the world when she was big enough. Their bond persists across her sleep cycles. She visits him during her one-year wake.

**Baby form.** About the size of a loaf of bread. A cylinder body in blue, with two wings, two tiny claws, two tiny paws at the bottom, and two very cute eyes. She wears a bunch of medals on her chest from the contests she kept winning. Reference visual pending: Aza is drawing a baby Nalia on paper for the canonical image.

**Mountain form (legendary).** Mountain-sized and mountain-shaped. Calm closed eyes when sleeping. A forest grows on her back. A snow cap sits on top, and the snow cap becomes her wings when she wakes. Caves run through her. Exactly one animal shelter sits on her slope. There are no other buildings. The world knows she is a legendary dragon and treats her better than a regular mountain: forests are cultivated on her rather than buildings constructed.

**Awards (baby era).** Hundreds upon hundreds in Dragon Racing. Hundreds upon hundreds in Cutest Dragon. No other categories. She won so many she could barely move under the weight of the medals.

**Evolution.** Natural. One night Marcus went to bed, and in the morning Nalia was mountain-sized and the bond was deeper. No external trigger, no dream, no visitor, no noise. Just growth at the right moment.

**Sleep cycle.** Two million years asleep, one year awake, repeats. For most of history she is a mountain.

**Wake year.** During her one year awake, she helps other dragons, flies around, visits Marcus, and fights bad guys. She fights The Voice Below (the main, main villain). She fights Wonky Donkers. The Voice Below and Wonky Donkers connection gives the narrator a hook for crossover encounters when Nalia is awake.

**Reproduction.** None. There is only one Nalia, and she practically lives forever. She does not lay eggs. There will never be another Nalia. She is singular and eternal.

**Diet.** Nalia eats fruit from the Chromatic Fields. That fruit is scaled for a dragon her size: it is fruit-sized for her the way ordinary fruit is fruit-sized for a person. One bite does not fill her. She would need more than a million pieces of normal-sized fruit to be satisfied. Chromatic Fields fruit is her practical food source because it is the only fruit that scales to her.

**Bond type.** Nalia can be a team's best friend (group bond) or one player's best friend (individual bond). Player choice.

**Encounter rules.** Baby Nalia cannot be met. That era is closed. Mountain Nalia can be found and tamed. Taming has a loadout restriction: a player cannot bring a legendary dragon or a Chromatic dragon in their active party while seeking Nalia. Owning these dragons is fine. They just cannot travel with the player on the Nalia journey.

**Chromatic variant.** A multicolored Nalia exists in the Chromatic Fields. Finding her requires luck. The variant's typing is TBD by Aza (still Mountain, or gains a Chromatic element).
...
1. Visit the First Choice Stable — Choose and bond with your first dragonette
2. Adventure — Explore the world, encounter enemies, find new dragons
3. Tame More Dragons — Use berries, element crystals, candy, and care to build your team
4. Race — Enter your eligible dragons in races at stadiums
5. Earn 10 Badges — Each race win earns one or more badges
6. Challenge Draco — The final raid boss
7. Become a Dragonette Master — Defeat Draco and free it from the evil shell

### Post-Game

After becoming a Dragonette Master, you can continue playing. Draco joins your team (Thunder Cloud element unlocked). You gain access to special power-up potions to further strengthen your dragons. You can continue racing, adventuring, and collecting.
...
Power and Speed dragons are banned from standard races because:
...
While Power dragons have access to every element, each individual elemental power is weaker than a specialist dragon's version. This creates meaningful choices:

A psychic Power dragon's telekinesis is weaker than a true Psychic dragon's.
A fire Power dragon's flames are weaker than a true Fire dragon's.
Exception: Speed is identical — a Power dragon is exactly as fast as a Speed dragon (270 mph top speed).
Additional weaknesses: vulnerable to Thunder Cloud and Electric attacks.

### Why Not Always Choose Power?

Weaker individual abilities than specialists.
Vulnerable to Thunder Cloud (the final boss) and Electric types.
Banned from races (can't earn badges directly through racing).
Specialists excel in their domain.

---

## 18. Story Moments & Narrative Beats

These moments from the original game sessions can serve as inspiration for stories, cutscenes, book chapters, or episodic content.

#### The Disguised Dragon Incident

A villain disguised a Speed dragon as a regular dragon using cardboard to sneak it into a race. A Spirit dragon sensed the deception and alerted Aloha, who reported the dragon was going 100 mph faster than it should. A Psychic dragon then made all cardboard on the track disappear, revealing the costume and exposing the cheater.

**Themes:** Teamwork, truth vs. deception, the unique value of each dragon type.
...
#### The Battle with the Tow Road

A flying turtle with dragon-scale-energy shell armor attacked. A Psychic dragon tried throwing a tree at it with telekinesis — but it barely scratched the surface (only ~1% damage). The keepers realized the shell was made of pure dragon scale energy, which is weak to fire. Using fire breath, they scorched through the armor in just two hits, defeating the turtle and harvesting dragon scale and turtle meat for their team.

**Themes:** Problem-solving, learning enemy weaknesses, teamwork between different dragon types.

#### The Force Field Test

After obtaining dragon scale from the Tow Road, keepers placed it on their dragons to activate force fields. They tested the force fields by firing attacks at each other — the fields absorbed and reflected the attacks. This proved the armor worked and prepared the team for bigger battles ahead.

**Themes:** Preparation, trust between teammates, testing before the real fight.

#### The First Race

Two keepers entered a race as a team — one with a Grass dragon (Leaf Blade) and one with a Spirit dragon. The Grass dragon created a razor-leaf wall as an obstacle, but since they were on the same team, both could pass through it. Wonky Donkers showed up with a disguised Power dragon (cardboard costume visible), but was detected. The team won the race by flying through the flashing trophy at the right moment, earning five badges.

**Themes:** Friendship, strategy, humor (Wonky Donkers), the thrill of competition.

#### The Gift of Transformation

A keeper with a deep bond to their dragons received a Dragon Eye Amulet — a glowstone containing the eye of a dragon — granting the ability to transform into any bonded dragonette. The keeper could now become their dragon while keeping their own mind, unlocking a new level of power and connection.
...
These are areas that need further development as the Draco universe expands.
...
How many different racetracks or stadiums exist? Are there different race formats (speed, obstacle course, combat race)? Can badges be lost or must they be defended? What happens if you lose a race? Can a single race award more than one badge?

### Items & Economy

Are there shops or marketplaces? How are element crystals found? Are there different tiers of candy or crystals? Can items be traded between keepers? What other special berries exist beyond the Tow Road dimension berries?

### Multiplayer / Social

Can keepers trade dragons? Are there keeper-vs-keeper battles (outside of races)? Can keepers form permanent teams or guilds?
...
When in the game progression does transformation become available? Are there limits to how long you can stay transformed? Can you transform during races or battles? Does transformation affect game balance — and if so, how is it managed? Where does the Dragon Eye Amulet come from?
...
Nalia. Mountain element (legendary). Tamer: Marcus (The Finisher). The first documented Draco Legend. Singular and eternal. Sleeps two million years as a literal mountain, wakes one year, repeats. See Section 15 (Draco Legends).
...
**Chromatic Nalia.** A multicolored variant of the legendary mountain dragon Nalia, found only in the Chromatic Fields. Lucky-find. Typing is TBD by Aza (still Mountain, or gains a Chromatic element).
...
**Dragon Scale** — Armor material obtained from defeated shelled enemies whose shells are made of pure dragon scale energy. Creates force fields when placed on a dragon.

**Dragon Shell Crystal** — The crystallized remains of a defeated shelled enemy that hardens into a usable dragon scale.
...
**Element Candy** — Element-specific candy fed to dragons during the taming/bonding process.

**Element Crystals** — Crystals matching a dragon's element, placed into crystal slots on the edges of a dragon's wings to strengthen the bond.
...
**Legend Codex.** The in-world name for the Draco Legends chapter. The place where every Draco Legend is documented. At launch it holds Nalia. New legends are added as Aza invents them.

**Magic Acorn** — Glowing acorn that grows into a magic oak in one day. The oak produces rare berries forever.

**Marcus (The Finisher)** — Formerly a middle-tier racer who found purpose helping an injured dragon. Also the childhood tamer of Nalia, the first Draco Legend, whom he raised and released into the world. See Section 15.

**Mountain (Element).** A brand-new legendary element belonging to Nalia. Legendary-only. Specific powers and matchups are TBD by Aza. The element is named for what its wielder literally becomes when she sleeps.
...
**Nalia.** The first Draco Legend. Pronounced NAH-lee-yah. She/her. Mountain element. Tamer: Marcus (The Finisher). Baby form is a loaf-of-bread-sized blue cylinder with two wings, two tiny claws, two tiny paws, two cute eyes, and many medals; mountain form is mountain-sized, with a forest on her back and a snow cap that becomes her wings when she wakes. Sleeps two million years, wakes for one, repeats. Singular and eternal. See Section 15 (Draco Legends).
...
*"The goal of the game is to become a Dragonette Master." — Aza Dixon, Creator of Draco*
